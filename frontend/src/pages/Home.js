          ...
          >
            <motion.div variants={slideInLeft}>
              <motion.div className="mb-8">
                ...
                <motion.h1 
                  className="text-7xl lg:text-8xl font-bold text-[#1A1A1A] uppercase leading-none mb-6"
                  variants={fadeInUp}
                >
                  {profileData.name.split(' ').map((word, idx) => (
                    <motion.span
                      key={idx}
                ...
                <motion.p 
                  className="text-xl text-[#333] leading-relaxed"
                  variants={fadeInUp}
                >
                  {profileData.tagline}
                </motion.p>
        ...
        >
          <div className= "max-w-7xl mx-auto ">
            <motion.div className= "mb-12 " variants={fadeInUp}>
              ...
              <h2 className= "text-5xl font-bold text-[#1A1A1A] uppercase ">About</h2>
            </motion.div>
            <motion.div 
        ...
        >
          <div className= "max-w-7xl mx-auto ">
            <motion.div className= "mb-12 " variants={fadeInUp}>
              ...
              <h2 className=  "text-5xl font-bold text-[#1A1A1A] uppercase  ">Skills & Expertise</h2>
            </motion.div>
            <motion.div 
            ...
            >
              {skills.map((skillCategory, idx) => (
                <motion.div 
                  ...
                  viewport={{ once: true }}
                >
                  <h3 className=  "text-xl font-bold text-[#1A1A1A] mb-6 uppercase  ">{skillCategory.category}</h3>
          ...
          <div className="max-w-7xl mx-auto">
            <motion.div className=  "flex justify-between items-end mb-12  " variants={fadeInUp}>
              <div>
                ...
                <h2 className=  "text-5xl font-bold text-[#1A1A1A] uppercase  ">Certificates</h2>
              </div>
              <Link 
                to=  "/certificates  " 
                ...
                >
                  ...
                  <div className=  "p-6  ">
                    <div className=  "flex items-start gap-3 mb-3  ">
                      ...
                      <h3 className=  "font-bold text-[#1A1A1A] text-lg leading-tight  ">{cert.title}</h3>
                    </div>
          ...
          <div className=  "max-w-7xl mx-auto  ">
            <motion.div className=  "flex justify-between items-end mb-12  " variants={fadeInUp}>
              <div>
                ...
                <h2 className=  "text-5xl font-bold text-[#1A1A1A] uppercase  ">Featured Projects</h2>
              </div>
              <Link 
                to=  "/projects  " 
                className=  "text-[#0066FF] font-semibold uppercase text-sm tracking-wider hover:underline flex items-center gap-2 hover:gap-4 transition-all  "
            ...
            >
              {projects.slice(0, 4).map((project, idx) => (
                ...
                >
                  ...
                  >
                    <motion.div 
                      className=  "aspect-[16/10] overflow-hidden bg-[#F5F5F5]  "
                      whileHover={{ scale: 1.02 }}
                    >
                      <motion.img 
                        src={project.image} 
                    ...
                    >
                      ...
                      <h3 className=  "text-2xl font-bold text-[#1A1A1A] mb-3 uppercase  ">{project.title}</h3>
                      <p className=  "text-[#666] leading-relaxed mb-4  ">{project.description}</p>
        ...
        >
          <div className=  "max-w-4xl mx-auto  ">
            <motion.div className=  "mb-12 text-center  " variants={fadeInUp}>
              ...
              <h2 className=  "text-5xl font-bold text-[#1A1A1A] uppercase mb-4  ">Contact</h2>
